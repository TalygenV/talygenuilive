(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-7785c63d"],{
...
// UNUSED EXPORTS: DayGridView, DayTable, DayTableSlicer, Table, TableView, buildDayTableModel
...
var main_TableView = /** @class */ (function (_super) {
    ...
    function TableView() {
        ...
        _this.headerElRef = Object(common_main["M" /* createRef */])();
        return _this;
    }
    TableView.prototype.renderSimpleLayout = function (headerRowContent, bodyContent) {
        var _a = this, props = _a.props, context = _a.context;
        var sections = [];
        var stickyHeaderDates = Object(common_main["S" /* getStickyHeaderDates */])(context.options);
        if (headerRowContent) {
            sections.push({
                type: 'header',
                key: 'header',
        ...
        return (Object(common_main["J" /* createElement */])(common_main["z" /* ViewRoot */], { viewSpec: context.viewSpec }, function (rootElRef, classNames) { return (Object(common_main["J" /* createElement */])("div", { ref: rootElRef, className: ['fc-daygrid'].concat(classNames).join(' ') },
            Object(common_main["J" /* createElement */])(common_main["w" /* SimpleScrollGrid */], { liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: props.forPrint, cols: [] /* TODO: make optional? */, sections: sections }))); }));
    };
    TableView.prototype.renderHScrollLayout = function (headerRowContent, bodyContent, colCnt, dayMinWidth) {
        ...
        var _a = this, props = _a.props, context = _a.context;
        var stickyHeaderDates = !props.forPrint && Object(common_main["S" /* getStickyHeaderDates */])(context.options);
        var stickyFooterScrollbar = !props.forPrint && Object(common_main["R" /* getStickyFooterScrollbar */])(context.options);
        var sections = [];
        if (headerRowContent) {
            sections.push({
                type: 'header',
        ...
        if (stickyFooterScrollbar) {
            sections.push({
                ...
                chunks: [{
                        key: 'main',
                        content: common_main["bb" /* renderScrollShim */],
                    }],
            });
        }
        return (Object(common_main["J" /* createElement */])(common_main["z" /* ViewRoot */], { viewSpec: context.viewSpec }, function (rootElRef, classNames) { return (Object(common_main["J" /* createElement */])("div", { ref: rootElRef, className: ['fc-daygrid'].concat(classNames).join(' ') },
            Object(common_main["J" /* createElement */])(ScrollGrid, { liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: props.forPrint, colGroups: [{ cols: [{ span: colCnt, minWidth: dayMinWidth }] }], sections: sections }))); }));
    };
    return TableView;
}(common_main["h" /* DateComponent */]));
...
var main_TableCellTop = /** @class */ (function (_super) {
    ...
    TableCellTop.prototype.render = function () {
        ...
        var navLinkAttrs = Object(common_main["G" /* buildNavLinkAttrs */])(this.context, props.date);
        return (Object(common_main["J" /* createElement */])(common_main["j" /* DayCellContent */], { date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, defaultContent: renderTopInner }, function (innerElRef, innerContent) { return ((innerContent || props.forceDayTop) && (Object(common_main["J" /* createElement */])("div", { className: "fc-daygrid-day-top", ref: innerElRef },
            Object(common_main["J" /* createElement */])("a", __assign({ id: props.dayNumberId, className: "fc-daygrid-day-number" }, navLinkAttrs), innerContent || Object(common_main["J" /* createElement */])(common_main["q" /* Fragment */], null, "\u00A0"))))); }));
    };
    return TableCellTop;
}(common_main["a" /* BaseComponent */]));
function renderTopInner(props) {
    return props.dayNumberText;
}

var DEFAULT_TABLE_EVENT_TIME_FORMAT = Object(common_main["K" /* createFormatter */])({
    hour: 'numeric',
    minute: '2-digit',
    omitZeroMinute: true,
    meridiem: 'narrow',
...
var main_TableListItemEvent = /** @class */ (function (_super) {
    ...
    TableListItemEvent.prototype.render = function () {
        ...
        var timeText = Object(common_main["H" /* buildSegTimeText */])(props.seg, timeFormat, context, true, props.defaultDisplayEventEnd);
        return (Object(common_main["J" /* createElement */])(common_main["p" /* EventRoot */], { seg: props.seg, timeText: timeText, defaultContent: renderInnerContent, isDragging: props.isDragging, isResizing: false, isDateSelecting: false, isSelected: props.isSelected, isPast: props.isPast, isFuture: props.isFuture, isToday: props.isToday }, function (rootElRef, classNames, innerElRef, innerContent) { return ( // we don't use styles!
        Object(common_main["J" /* createElement */])("a", __assign({ className: ['fc-daygrid-event', 'fc-daygrid-dot-event'].concat(classNames).join(' '), ref: rootElRef }, Object(common_main["P" /* getSegAnchorAttrs */])(props.seg, context)), innerContent)); }));
    };
    return TableListItemEvent;
}(common_main["a" /* BaseComponent */]));
function renderInnerContent(innerProps) {
    return (Object(common_main["J" /* createElement */])(common_main["q" /* Fragment */], null,
        Object(common_main["J" /* createElement */])("div", { className: "fc-daygrid-event-dot", style: { borderColor: innerProps.borderColor || innerProps.backgroundColor } }),
        innerProps.timeText && (Object(common_main["J" /* createElement */])("div", { className: "fc-event-time" }, innerProps.timeText)),
        Object(common_main["J" /* createElement */])("div", { className: "fc-event-title" }, innerProps.event.title || Object(common_main["J" /* createElement */])(common_main["q" /* Fragment */], null, "\u00A0"))));
}
...
var main_TableCellMoreLink = /** @class */ (function (_super) {
    ...
    function TableCellMoreLink() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.compileSegs = Object(common_main["Y" /* memoize */])(compileSegs);
        return _this;
    }
    TableCellMoreLink.prototype.render = function () {
        var props = this.props;
        var _a = this.compileSegs(props.singlePlacements), allSegs = _a.allSegs, invisibleSegs = _a.invisibleSegs;
        return (Object(common_main["J" /* createElement */])(common_main["r" /* MoreLinkRoot */], { dateProfile: props.dateProfile, todayRange: props.todayRange, allDayDate: props.allDayDate, moreCnt: props.moreCnt, allSegs: allSegs, hiddenSegs: invisibleSegs, alignmentElRef: props.alignmentElRef, alignGridTop: props.alignGridTop, extraDateSpan: props.extraDateSpan, popoverContent: function () {
                var isForcedInvisible = (props.eventDrag ? props.eventDrag.affectedInstances : null) ||
                    (props.eventResize ? props.eventResize.affectedInstances : null) ||
                    {};
                return (Object(common_main["J" /* createElement */])(common_main["q" /* Fragment */], null, allSegs.map(function (seg) {
                    var instanceId = seg.eventRange.instance.instanceId;
                    return (Object(common_main["J" /* createElement */])("div", { className: "fc-daygrid-event-harness", key: instanceId, style: {
                            visibility: isForcedInvisible[instanceId] ? 'hidden' : '',
                        } }, hasListItemDisplay(seg) ? (Object(common_main["J" /* createElement */])(main_TableListItemEvent, __assign({ seg: seg, isDragging: false, isSelected: instanceId === props.eventSelection, defaultDisplayEventEnd: false }, Object(common_main["Q" /* getSegMeta */])(seg, props.todayRange)))) : (Object(common_main["J" /* createElement */])(main_TableBlockEvent, __assign({ seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === props.eventSelection, defaultDisplayEventEnd: false }, Object(common_main["Q" /* getSegMeta */])(seg, props.todayRange))))));
                })));
            } }, function (rootElRef, classNames, innerElRef, innerContent, handleClick, title, isExpanded, popoverId) { return (Object(common_main["J" /* createElement */])("a", __assign({ ref: rootElRef, className: ['fc-daygrid-more-link'].concat(classNames).join(' '), title: title, "aria-expanded": isExpanded, "aria-controls": popoverId }, Object(common_main["I" /* createAriaClickAttrs */])(handleClick)), innerContent)); }));
    };
...
var DEFAULT_WEEK_NUM_FORMAT = Object(common_main["K" /* createFormatter */])({ week: 'narrow' });
var main_TableCell = /** @class */ (function (_super) {
    __extends(TableCell, _super);
    function TableCell() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.rootElRef = Object(common_main["M" /* createRef */])();
        _this.state = {
            dayNumberId: Object(common_main["T" /* getUniqueDomId */])(),
        };
        _this.handleRootEl = function (el) {
            Object(common_main["cb" /* setRef */])(_this.rootElRef, el);
            Object(common_main["cb" /* setRef */])(_this.props.elRef, el);
        };
        return _this;
    }
    TableCell.prototype.render = function () {
        ...
        var navLinkAttrs = Object(common_main["G" /* buildNavLinkAttrs */])(context, date, 'week');
        return (Object(common_main["J" /* createElement */])(common_main["k" /* DayCellRoot */], { date: date, dateProfile: dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, elRef: this.handleRootEl }, function (dayElRef, dayClassNames, rootDataAttrs, isDisabled) { return (Object(common_main["J" /* createElement */])("td", __assign({ ref: dayElRef, role: "gridcell", className: ['fc-daygrid-day'].concat(dayClassNames, props.extraClassNames || []).join(' ') }, rootDataAttrs, props.extraDataAttrs, (props.showDayNumber ? { 'aria-labelledby': state.dayNumberId } : {})),
            Object(common_main["J" /* createElement */])("div", { className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", ref: props.innerElRef /* different from hook system! RENAME */ },
                props.showWeekNumber && (Object(common_main["J" /* createElement */])(common_main["A" /* WeekNumberRoot */], { date: date, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, function (weekElRef, weekClassNames, innerElRef, innerContent) { return (Object(common_main["J" /* createElement */])("a", __assign({ ref: weekElRef, className: ['fc-daygrid-week-number'].concat(weekClassNames).join(' ') }, navLinkAttrs), innerContent)); })),
                !isDisabled && (Object(common_main["J" /* createElement */])(main_TableCellTop, { date: date, dateProfile: dateProfile, showDayNumber: props.showDayNumber, dayNumberId: state.dayNumberId, forceDayTop: props.forceDayTop, todayRange: props.todayRange, extraHookProps: props.extraHookProps })),
                Object(common_main["J" /* createElement */])("div", { className: "fc-daygrid-day-events", ref: props.fgContentElRef },
                    props.fgContent,
                    Object(common_main["J" /* createElement */])("div", { className: "fc-daygrid-day-bottom", style: { marginTop: props.moreMarginTop } },
                        Object(common_main["J" /* createElement */])(main_TableCellMoreLink, { allDayDate: date, singlePlacements: props.singlePlacements, moreCnt: props.moreCnt, alignmentElRef: rootElRef, alignGridTop: !props.showDayNumber, extraDateSpan: props.extraDateSpan, dateProfile: props.dateProfile, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, todayRange: props.todayRange }))),
                Object(common_main["J" /* createElement */])("div", { className: "fc-daygrid-day-bg" }, props.bgContent)))); }));
    };
    return TableCell;
}(common_main["h" /* DateComponent */]));
...
function resliceSeg(seg, spanStart, spanEnd, cells) {
    ...
    var slicedRange = Object(common_main["U" /* intersectRanges */])(origRange, {
        start: cells[spanStart].date,
        end: Object(common_main["B" /* addDays */])(cells[spanEnd - 1].date, 1),
    });
...
var main_DayGridSegHierarchy = /** @class */ (function (_super) {
    ...
    DayGridSegHierarchy.prototype.addSegs = function (segInputs) {
        ...
        var excludeHidden = function (entry) { return !_this.forceHidden[Object(common_main["E" /* buildEntryKey */])(entry)]; };
    ...
    DayGridSegHierarchy.prototype.handleInvalidInsertion = function (insertion, entry, hiddenEntries) {
        ...
        if (this.hiddenConsumes && touchingEntry) {
            var touchingEntryId = Object(common_main["E" /* buildEntryKey */])(touchingEntry);
            // if not already hidden
            if (!forceHidden[touchingEntryId]) {
                if (this.allowReslicing) {
                    var placeholderEntry = __assign(__assign({}, touchingEntry), { span: Object(common_main["V" /* intersectSpans */])(touchingEntry.span, entry.span) });
                    var placeholderEntryId = Object(common_main["E" /* buildEntryKey */])(placeholderEntry);
...
}(common_main["v" /* SegHierarchy */]));

var main_TableRow = /** @class */ (function (_super) {
    __extends(TableRow, _super);
    function TableRow() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.cellElRefs = new common_main["u" /* RefMap */](); // the <td>
        _this.frameElRefs = new common_main["u" /* RefMap */](); // the fc-daygrid-day-frame
        _this.fgElRefs = new common_main["u" /* RefMap */](); // the fc-daygrid-day-events
        _this.segHarnessRefs = new common_main["u" /* RefMap */](); // indexed by "instanceId:firstCol"
        _this.rootElRef = Object(common_main["M" /* createRef */])();
        _this.state = {
            framePositions: null,
    ...
    TableRow.prototype.render = function () {
        ...
        var _b = computeFgSegPlacement(Object(common_main["db" /* sortEventSegs */])(props.fgEventSegs, options.eventOrder), props.dayMaxEvents, props.dayMaxEventRows, options.eventOrderStrict, state.eventInstanceHeights, state.maxContentHeight, props.cells), singleColPlacements = _b.singleColPlacements, multiColPlacements = _b.multiColPlacements, moreCnts = _b.moreCnts, moreMarginTops = _b.moreMarginTops;
        var isForcedInvisible = // TODO: messy way to compute this
         (props.eventDrag && props.eventDrag.affectedInstances) ||
            (props.eventResize && props.eventResize.affectedInstances) ||
            {};
        return (Object(common_main["J" /* createElement */])("tr", { ref: this.rootElRef, role: "row" },
            props.renderIntro && props.renderIntro(),
            props.cells.map(function (cell, col) {
                var normalFgNodes = _this.renderFgSegs(col, props.forPrint ? singleColPlacements[col] : multiColPlacements[col], props.todayRange, isForcedInvisible);
                var mirrorFgNodes = _this.renderFgSegs(col, buildMirrorPlacements(mirrorSegsByCol[col], multiColPlacements), props.todayRange, {}, Boolean(props.eventDrag), Boolean(props.eventResize), false);
                return (Object(common_main["J" /* createElement */])(main_TableCell, { key: cell.key, elRef: _this.cellElRefs.createRef(cell.key), innerElRef: _this.frameElRefs.createRef(cell.key) /* FF <td> problem, but okay to use for left/right. TODO: rename prop */, dateProfile: props.dateProfile, date: cell.date, showDayNumber: props.showDayNumbers, showWeekNumber: props.showWeekNumbers && col === 0, forceDayTop: props.showWeekNumbers /* even displaying weeknum for row, not necessarily day */, todayRange: props.todayRange, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, extraHookProps: cell.extraHookProps, extraDataAttrs: cell.extraDataAttrs, extraClassNames: cell.extraClassNames, extraDateSpan: cell.extraDateSpan, moreCnt: moreCnts[col], moreMarginTop: moreMarginTops[col], singlePlacements: singleColPlacements[col], fgContentElRef: _this.fgElRefs.createRef(cell.key), fgContent: ( // Fragment scopes the keys
                    Object(common_main["J" /* createElement */])(common_main["q" /* Fragment */], null,
                        Object(common_main["J" /* createElement */])(common_main["q" /* Fragment */], null, normalFgNodes),
                        Object(common_main["J" /* createElement */])(common_main["q" /* Fragment */], null, mirrorFgNodes))), bgContent: ( // Fragment scopes the keys
                    Object(common_main["J" /* createElement */])(common_main["q" /* Fragment */], null,
    ...
    TableRow.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        this.updateSizing(!Object(common_main["X" /* isPropsEqual */])(prevProps, currentProps));
    };
    ...
    TableRow.prototype.renderFgSegs = function (col, segPlacements, todayRange, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
        ...
        if (framePositions) {
            for (var _i = 0, segPlacements_1 = segPlacements; _i < segPlacements_1.length; _i++) {
                ...
                */
                nodes.push(Object(common_main["J" /* createElement */])("div", { className: 'fc-daygrid-event-harness' + (isAbsolute ? ' fc-daygrid-event-harness-abs' : ''), key: key, ref: isMirror ? null : this.segHarnessRefs.createRef(key), style: {
                        visibility: isVisible ? '' : 'hidden',
                        marginTop: isAbsolute ? '' : placement.marginTop,
                        top: isAbsolute ? placement.absoluteTop : '',
                        left: left,
                        right: right,
                    } }, hasListItemDisplay(seg) ? (Object(common_main["J" /* createElement */])(main_TableListItemEvent, __assign({ seg: seg, isDragging: isDragging, isSelected: instanceId === eventSelection, defaultDisplayEventEnd: defaultDisplayEventEnd }, Object(common_main["Q" /* getSegMeta */])(seg, todayRange)))) : (Object(common_main["J" /* createElement */])(main_TableBlockEvent, __assign({ seg: seg, isDragging: isDragging, isResizing: isResizing, isDateSelecting: isDateSelecting, isSelected: instanceId === eventSelection, defaultDisplayEventEnd: defaultDisplayEventEnd }, Object(common_main["Q" /* getSegMeta */])(seg, todayRange))))));
            }
        }
        return nodes;
    };
    TableRow.prototype.renderFillSegs = function (segs, fillType) {
        ...
        if (framePositions) {
            for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                ...
                nodes.push(Object(common_main["J" /* createElement */])("div", { key: Object(common_main["F" /* buildEventRangeKey */])(seg.eventRange), className: "fc-daygrid-bg-harness", style: leftRightCss }, fillType === 'bg-event' ?
                    Object(common_main["J" /* createElement */])(common_main["b" /* BgEvent */], __assign({ seg: seg }, Object(common_main["Q" /* getSegMeta */])(seg, todayRange))) :
                    Object(common_main["ab" /* renderFill */])(fillType)));
            }
        }
        return common_main["J" /* createElement */].apply(void 0, __spreadArray([common_main["q" /* Fragment */], {}], nodes));
    };
        ...
        if (!props.forPrint &&
            ...
            if (isExternalSizingChange) {
                ...
                if (frameEls.length) {
                    ...
                    this.setState({
                        framePositions: new common_main["t" /* PositionCache */](originEl, frameEls, true, // isHorizontal
                        false),
                    });
                }
            }
...
main_TableRow.addStateEquality({
    eventInstanceHeights: common_main["X" /* isPropsEqual */],
});
...
var main_Table = /** @class */ (function (_super) {
    ...
    function Table() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.splitBusinessHourSegs = Object(common_main["Y" /* memoize */])(splitSegsByRow);
        _this.splitBgEventSegs = Object(common_main["Y" /* memoize */])(splitSegsByRow);
        _this.splitFgEventSegs = Object(common_main["Y" /* memoize */])(splitSegsByRow);
        _this.splitDateSelectionSegs = Object(common_main["Y" /* memoize */])(splitSegsByRow);
        _this.splitEventDrag = Object(common_main["Y" /* memoize */])(splitInteractionByRow);
        _this.splitEventResize = Object(common_main["Y" /* memoize */])(splitInteractionByRow);
        _this.rowRefs = new common_main["u" /* RefMap */]();
    ...
    Table.prototype.render = function () {
        ...
        return (Object(common_main["J" /* createElement */])("div", { className: classNames.join(' '), ref: this.handleRootEl, style: {
                // these props are important to give this wrapper correct dimensions for interactions
                // TODO: if we set it here, can we avoid giving to inner tables?
                width: props.clientWidth,
                minWidth: props.tableMinWidth,
            } },
            Object(common_main["J" /* createElement */])(common_main["s" /* NowTimer */], { unit: "day" }, function (nowDate, todayRange) { return (Object(common_main["J" /* createElement */])(common_main["q" /* Fragment */], null,
                Object(common_main["J" /* createElement */])("table", { role: "presentation", className: "fc-scrollgrid-sync-table", style: {
                        width: props.clientWidth,
                        minWidth: props.tableMinWidth,
                        height: expandRows ? props.clientHeight : '',
                    } },
                    props.colGroupNode,
                    Object(common_main["J" /* createElement */])("tbody", { role: "presentation" }, props.cells.map(function (cells, row) { return (Object(common_main["J" /* createElement */])(main_TableRow, { ref: _this.rowRefs.createRef(row), key: cells.length
    ...
    Table.prototype.prepareHits = function () {
        this.rowPositions = new common_main["t" /* PositionCache */](this.rootEl, this.rowRefs.collect().map(function (rowObj) { return rowObj.getCellEls()[0]; }), // first cell el in each row. TODO: not optimal
        false, true);
        this.colPositions = new common_main["t" /* PositionCache */](this.rootEl, this.rowRefs.currentMap[0].getCellEls(), // cell els in first row
        true, // horizontal
        false);
    };
    ...
    Table.prototype.getCellRange = function (row, col) {
        ...
        var end = Object(common_main["B" /* addDays */])(start, 1);
...
var main_DayTable = /** @class */ (function (_super) {
    ...
    function DayTable() {
        ...
        _this.tableRef = Object(common_main["M" /* createRef */])();
        return _this;
    }
    DayTable.prototype.render = function () {
        var _a = this, props = _a.props, context = _a.context;
        return (Object(common_main["J" /* createElement */])(main_Table, __assign({ ref: this.tableRef }, this.slicer.sliceProps(props, props.dateProfile, props.nextDayThreshold, context, props.dayTableModel), { dateProfile: props.dateProfile, cells: props.dayTableModel.cells, colGroupNode: props.colGroupNode, tableMinWidth: props.tableMinWidth, renderRowIntro: props.renderRowIntro, dayMaxEvents: props.dayMaxEvents, dayMaxEventRows: props.dayMaxEventRows, showWeekNumbers: props.showWeekNumbers, expandRows: props.expandRows, headerAlignElRef: props.headerAlignElRef, clientWidth: props.clientWidth, clientHeight: props.clientHeight, forPrint: props.forPrint })));
    };
    return DayTable;
}(common_main["h" /* DateComponent */]));
...
var main_DayTableView = /** @class */ (function (_super) {
    ...
    function DayTableView() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.buildDayTableModel = Object(common_main["Y" /* memoize */])(buildDayTableModel);
        _this.headerRef = Object(common_main["M" /* createRef */])();
        _this.tableRef = Object(common_main["M" /* createRef */])();
        return _this;
    }
    DayTableView.prototype.render = function () {
        ...
        var headerContent = options.dayHeaders && (Object(common_main["J" /* createElement */])(common_main["l" /* DayHeader */], { ref: this.headerRef, dateProfile: props.dateProfile, dates: dayTableModel.headerDates, datesRepDistinctDays: dayTableModel.rowCnt === 1 }));
        var bodyContent = function (contentArg) { return (Object(common_main["J" /* createElement */])(main_DayTable, { ref: _this.tableRef, dateProfile: props.dateProfile, dayTableModel: dayTableModel, businessHours: props.businessHours, dateSelection: props.dateSelection, eventStore: props.eventStore, eventUiBases: props.eventUiBases, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, nextDayThreshold: options.nextDayThreshold, colGroupNode: contentArg.tableColGroupNode, tableMinWidth: contentArg.tableMinWidth, dayMaxEvents: options.dayMaxEvents, dayMaxEventRows: options.dayMaxEventRows, showWeekNumbers: options.weekNumbers, expandRows: !props.isHeightAuto, headerAlignElRef: _this.headerElRef, clientWidth: contentArg.clientWidth, clientHeight: contentArg.clientHeight, forPrint: props.forPrint })); };
...
function buildDayTableModel(dateProfile, dateProfileGenerator) {
    var daySeries = new common_main["m" /* DaySeriesModel */](dateProfile.renderRange, dateProfileGenerator);
    return new common_main["n" /* DayTableModel */](daySeries, /year|month|week/.test(dateProfile.currentRangeUnit));
}
    ...
    TableDateProfileGenerator.prototype.buildRenderRange = function (currentRange, currentRangeUnit, isRangeAllDay) {
        ...
        if (/^(year|month)$/.test(currentRangeUnit)) {
            ...
            if (endOfWeek.valueOf() !== end.valueOf()) {
                end = Object(common_main["C" /* addWeeks */])(endOfWeek, 1);
            }
        }
        // ensure 6 weeks
        if (this.props.monthMode &&
            ...
            Object(common_main["N" /* diffWeeks */])(start, end));
            end = Object(common_main["C" /* addWeeks */])(end, 6 - rowCnt);
        }
        return { start: start, end: end };
    };
    return TableDateProfileGenerator;
}(common_main["i" /* DateProfileGenerator */]));

var main_main = Object(common_main["L" /* createPlugin */])({
...
/* harmony default export */ var daygrid_main = __webpack_exports__["a"] = (main_main);
...
var update = add("0e6ef9e6", content, true, {"sourceMap":false,"shadowMode":false});
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "q", function() { return /* reexport */ Fragment; });
__webpack_require__.d(__webpack_exports__, "J", function() { return /* reexport */ createElement; });
__webpack_require__.d(__webpack_exports__, "M", function() { return /* reexport */ createRef; });
__webpack_require__.d(__webpack_exports__, "O", function() { return /* reexport */ flushSync; });
__webpack_require__.d(__webpack_exports__, "Z", function() { return /* reexport */ render; });
__webpack_require__.d(__webpack_exports__, "eb", function() { return /* reexport */ unmountComponentAtNode; });
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ main_BaseComponent; });
__webpack_require__.d(__webpack_exports__, "b", function() { return /* binding */ BgEvent; });
__webpack_require__.d(__webpack_exports__, "c", function() { return /* binding */ main_CalendarApi; });
__webpack_require__.d(__webpack_exports__, "d", function() { return /* binding */ main_CalendarContent; });
__webpack_require__.d(__webpack_exports__, "e", function() { return /* binding */ main_CalendarDataManager; });
__webpack_require__.d(__webpack_exports__, "f", function() { return /* binding */ main_CalendarRoot; });
__webpack_require__.d(__webpack_exports__, "g", function() { return /* binding */ CustomContentRenderContext; });
__webpack_require__.d(__webpack_exports__, "h", function() { return /* binding */ main_DateComponent; });
__webpack_require__.d(__webpack_exports__, "i", function() { return /* binding */ DateProfileGenerator; });
__webpack_require__.d(__webpack_exports__, "j", function() { return /* binding */ main_DayCellContent; });
__webpack_require__.d(__webpack_exports__, "k", function() { return /* binding */ main_DayCellRoot; });
__webpack_require__.d(__webpack_exports__, "l", function() { return /* binding */ main_DayHeader; });
__webpack_require__.d(__webpack_exports__, "m", function() { return /* binding */ DaySeriesModel; });
__webpack_require__.d(__webpack_exports__, "n", function() { return /* binding */ DayTableModel; });
__webpack_require__.d(__webpack_exports__, "o", function() { return /* binding */ DelayedRunner; });
__webpack_require__.d(__webpack_exports__, "p", function() { return /* binding */ main_EventRoot; });
__webpack_require__.d(__webpack_exports__, "r", function() { return /* binding */ main_MoreLinkRoot; });
__webpack_require__.d(__webpack_exports__, "s", function() { return /* binding */ main_NowTimer; });
__webpack_require__.d(__webpack_exports__, "t", function() { return /* binding */ PositionCache; });
__webpack_require__.d(__webpack_exports__, "u", function() { return /* binding */ RefMap; });
__webpack_require__.d(__webpack_exports__, "v", function() { return /* binding */ main_SegHierarchy; });
__webpack_require__.d(__webpack_exports__, "w", function() { return /* binding */ main_SimpleScrollGrid; });
__webpack_require__.d(__webpack_exports__, "x", function() { return /* binding */ main_Slicer; });
__webpack_require__.d(__webpack_exports__, "y", function() { return /* binding */ main_StandardEvent; });
__webpack_require__.d(__webpack_exports__, "z", function() { return /* binding */ main_ViewRoot; });
__webpack_require__.d(__webpack_exports__, "A", function() { return /* binding */ WeekNumberRoot; });
__webpack_require__.d(__webpack_exports__, "B", function() { return /* binding */ addDays; });
__webpack_require__.d(__webpack_exports__, "C", function() { return /* binding */ addWeeks; });
__webpack_require__.d(__webpack_exports__, "D", function() { return /* binding */ applyStyleProp; });
__webpack_require__.d(__webpack_exports__, "E", function() { return /* binding */ buildEntryKey; });
__webpack_require__.d(__webpack_exports__, "F", function() { return /* binding */ buildEventRangeKey; });
__webpack_require__.d(__webpack_exports__, "G", function() { return /* binding */ buildNavLinkAttrs; });
__webpack_require__.d(__webpack_exports__, "H", function() { return /* binding */ buildSegTimeText; });
__webpack_require__.d(__webpack_exports__, "I", function() { return /* binding */ createAriaClickAttrs; });
__webpack_require__.d(__webpack_exports__, "K", function() { return /* binding */ createFormatter; });
__webpack_require__.d(__webpack_exports__, "L", function() { return /* binding */ createPlugin; });
__webpack_require__.d(__webpack_exports__, "N", function() { return /* binding */ diffWeeks; });
__webpack_require__.d(__webpack_exports__, "P", function() { return /* binding */ getSegAnchorAttrs; });
__webpack_require__.d(__webpack_exports__, "Q", function() { return /* binding */ getSegMeta; });
__webpack_require__.d(__webpack_exports__, "R", function() { return /* binding */ getStickyFooterScrollbar; });
__webpack_require__.d(__webpack_exports__, "S", function() { return /* binding */ getStickyHeaderDates; });
__webpack_require__.d(__webpack_exports__, "T", function() { return /* binding */ getUniqueDomId; });
__webpack_require__.d(__webpack_exports__, "U", function() { return /* binding */ intersectRanges; });
__webpack_require__.d(__webpack_exports__, "V", function() { return /* binding */ intersectSpans; });
__webpack_require__.d(__webpack_exports__, "W", function() { return /* binding */ isArraysEqual; });
__webpack_require__.d(__webpack_exports__, "X", function() { return /* binding */ isPropsEqual; });
__webpack_require__.d(__webpack_exports__, "Y", function() { return /* binding */ memoize; });
__webpack_require__.d(__webpack_exports__, "ab", function() { return /* binding */ renderFill; });
__webpack_require__.d(__webpack_exports__, "bb", function() { return /* binding */ renderScrollShim; });
__webpack_require__.d(__webpack_exports__, "cb", function() { return /* binding */ setRef; });
__webpack_require__.d(__webpack_exports__, "db", function() { return /* binding */ sortEventSegs; });

// UNUSED EXPORTS: Component, createContext, createPortal, BASE_OPTION_DEFAULTS, BASE_OPTION_REFINERS, CalendarDataProvider, ContentHook, DateEnv, ElementDragging, ElementScrollController, Emitter, EventApi, EventSourceApi, Interaction, MountHook, NamedTimeZoneImpl, NowIndicatorRoot, RenderHook, ScrollController, ScrollResponder, Scroller, Splitter, TableDateCell, TableDowCell, Theme, ViewApi, ViewContextType, WindowScrollController, addDurations, addMs, allowContextMenu, allowSelection, applyMutationToEventStore, applyStyle, asCleanDays, asRoughMinutes, asRoughMs, asRoughSeconds, binarySearch, buildClassNameNormalizer, buildEventApis, buildHashFromArray, buildIsoString, buildSegCompareObj, collectFromHash, combineEventUis, compareByFieldSpec, compareByFieldSpecs, compareNumbers, compareObjs, computeEarliestSegStart, computeEdges, computeFallbackHeaderFormat, computeHeightAndMargins, computeInnerRect, computeRect, computeSegDraggable, computeSegEndResizable, computeSegStartResizable, computeShrinkWidth, computeSmallestCellWidth, computeVisibleDayRange, config, constrainPoint, createDuration, createEmptyEventStore, createEventInstance, createEventUi, diffDates, diffDayAndTime, diffDays, diffPoints, diffWholeDays, diffWholeWeeks, disableCursor, elementClosest, elementMatches, enableCursor, eventTupleToStore, filterEventStoreDefs, filterHash, findDirectChildren, findElements, flexibleCompare, formatDate, formatDayString, formatIsoTimeString, formatRange, getAllowYScrolling, getCanVGrowWithinCell, getClippingParents, getDateMeta, getDayClassNames, getDefaultEventEnd, getElRoot, getElSeg, getEntrySpanEnd, getEventClassNames, getEventTargetViaRoot, getIsRtlScrollbarOnLeft, getRectCenter, getRelevantEvents, getScrollGridClassNames, getScrollbarWidths, getSectionClassNames, getSectionHasLiquidHeight, getSlotClassNames, getUnequalProps, globalLocales, globalPlugins, greatestDurationDenominator, groupIntersectingEntries, guid, hasBgRendering, hasShrinkWidth, identity, interactionSettingsStore, interactionSettingsToStore, intersectRects, isColPropsEqual, isDateSelectionValid, isDateSpansEqual, isInt, isInteractionValid, isMultiDayRange, isPropsValid, isValidDate, joinSpans, listenBySelector, mapHash, memoizeArraylike, memoizeHashlike, memoizeObjArg, mergeEventStores, multiplyDuration, padStart, parseBusinessHours, parseClassNames, parseDragMeta, parseEventDef, parseFieldSpecs, parseMarker, pointInsideRect, preventContextMenu, preventDefault, preventSelection, rangeContainsMarker, rangeContainsRange, rangesEqual, rangesIntersect, refineEventDef, refineProps, removeElement, removeExact, renderChunkContent, renderMicroColGroup, requestJson, sanitizeShrinkWidth, setElSeg, sliceEventStore, sliceEvents, startOfDay, translateRect, triggerDateSelect, unpromisify, version, whenTransitionDone, wholeDivideDurations
...
// load the styles
var content = __webpack_require__("0e8a");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("84bfd500", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/@fullcalendar/core/node_modules/tslib/tslib.es6.js
/******************************************************************************
Copyright (c) Microsoft Corporation.
...
function flushSync(runBeforeFlush) {
    ...
    D(y(vdom_FakeComponent, {}), document.createElement('div'));
...
var vdom_FakeComponent = /** @class */ (function (_super) {
    tslib_es6_extends(FakeComponent, _super);
...
function createContext(defaultValue) {
    var ContextType = G(defaultValue);
...
var main_Calendar = /** @class */ (function (_super) {
    tslib_es6_extends(Calendar, _super);
    function Calendar(el, optionOverrides) {
        ...
        _this.handleRenderRequest = function () {
            if (_this.isRendering) {
                ...
                Object(main["O" /* flushSync */])(function () {
                    Object(main["Z" /* render */])(Object(main["J" /* createElement */])(main["f" /* CalendarRoot */], { options: currentData_1.calendarOptions, theme: currentData_1.theme, emitter: currentData_1.emitter }, function (classNames, height, isHeightAuto, forPrint) {
                        _this.setClassNames(classNames);
                        _this.setHeight(height);
                        return (Object(main["J" /* createElement */])(main["g" /* CustomContentRenderContext */].Provider, { value: _this.customContentRenderId },
                            Object(main["J" /* createElement */])(main["d" /* CalendarContent */], tslib_es6_assign({ isHeightAuto: isHeightAuto, forPrint: forPrint }, currentData_1))));
                    }), _this.el);
                });
            }
            else if (_this.isRendered) {
                _this.isRendered = false;
                Object(main["eb" /* unmountComponentAtNode */])(_this.el);
                _this.setClassNames([]);
                _this.setHeight('');
            }
        };
        _this.el = el;
        _this.renderRunner = new main["o" /* DelayedRunner */](_this.handleRenderRequest);
        new main["e" /* CalendarDataManager */]({
    ...
    Calendar.prototype.setClassNames = function (classNames) {
        if (!Object(main["W" /* isArraysEqual */])(classNames, this.currentClassNames)) {
    ...
    Calendar.prototype.setHeight = function (height) {
        Object(main["D" /* applyStyleProp */])(this.el, 'height', height);
    };
    return Calendar;
}(main["c" /* CalendarApi */]));
...
function createVueContentTypePlugin(parent) {
    return Object(main["L" /* createPlugin */])({
        contentTypeHandlers: {
...
//# sourceMappingURL=chunk-7785c63d.js.map